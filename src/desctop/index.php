    ...
    <body>
        <?php include('../track/body.php'); ?>
            <header>
                <div class="wrap">
                    <a class="logo" href="#">
                        <img src="img/logo.png" alt height="21" width="97">
                    </a>
                    <h1>
                        <? echo $din_title; ?>
                    </h1>
                    <h2>Получите до
                        <span>50 новых заявок</span> на свои товары и услуги<br> в ближайшие
                        <span>14 дней</span>. Старт всего через
                        <span>6 часов</span>.</h2>
                    <div class="divider1"></div>
                    <div class="head_gr">
                        <div class="pl_gr">
                            <img src="img/more-calls.png" alt height="60" width="60">
                            <h4>На 80% больше звонков</h4>
                            <p>С помощью настроенной CRM</p>
                        </div>
                        <img class="plus" src="img/plus.png" alt height="32" width="32">
                        <div class="pl_gr">
                            <img src="img/clients-base.png" alt height="60" width="60">
                            <h4>Готовая база клиентов</h4>
                            <p>Больше 1 000 000 предприятий РФ</p>
                        </div>
                    </div>
                    <a class="btn_head" href="#">ЗАКАЗАТЬ ПРОБНУЮ ВЕРСИЮ</a>
                </div>
                ...
                <div class="pop" id="pop2">
                    <img src="img/form-sent-darkb.png" alt height="50" width="61">
            ...
            <section class="sec2">
                <div class="wrap">
                    ...
                    <div class="line">
                        ...
                        <div class="rez">
                            <span>5ч 15мин</span>
                            <h4>5. Ваши менеджеры<br> начали прозвон и собирают<br> первые заявки</h4>
                        </div>
                        <div class="rez">
                            <span>5ч 45мин</span>
                    ...
                    <div class="sec2_btn">
                        <a class="btn_pr" href="#">ЗАКАЗАТЬ ПРОБНУЮ ВЕРСИЮ</a>
                        <p>Или получите бесплатно список
                            <br> из 100 потенциальных клиентов</p>
                        <a class="btn_sp" href="#">Получить список клиентов</a>
                    </div>
                </div>
            </section>
            <section class="sec3">
                <div class="wrap">
                    ...
                    <div class="sec3_h4gr">
                        <h4>
                            <span>Двое и больше</span><br> менеджеров<br> по холодным звонкам</h4>
                        <h4>Холодные звонки — <br>
                            <span>основной источник</span> <br>новых клиентов</h4>
                        <h4>Цикл сделки: <br>
                    ...
                    <div class="container">
                        <div class="item">
                            <img src="img/services.png" alt height="48" width="48">
                            <p>Активные продажи товаров
                                <br> и услуг для населения</p>
                            <span>Есть пример внедрения</span>
                            <p>Продажа услуг страхования</p>
                            <span>Есть пример внедрения</span>
                            <p>Частные адвокаты
                                <br> и адвокатские конторы</p>
                            <span>Есть пример внедрения</span>
                            <p>Продажа инвестиционных услуг</p>
                            <span>Есть пример внедрения</span>
                            <p>Продажа услуг бухгалтерского, юридического
                                <br> и ИТ-обслуживания</p>
                            <p class="t4">Оценочная деятельность</p>
                            <img src="img/beauty.png" alt height="48" width="48">
                            <p>Продажа товаров
                                <br> для косметических салонов</p>
                            <span>Есть пример внедрения</span>
                        </div>
                        <div class="item">
                            <img src="img/it.png" alt height="48" width="48">
                            <p>Рекламные агентства</p>
                            <span>Есть пример внедрения</span>
                            <p>Веб-студии</p>
                            <p class="t4">Продажа программного обеспечения</p>
                            <img src="img/delivery.png" alt height="48" width="48">
                            <p>Доставка воды</p>
                            <span>Есть пример внедрения</span>
                            <p>Клининг</p>
                            <img src="img/gear.png" alt height="48" width="48">
                        ...
                        <div class="item">
                            <img src="img/corporate.png" alt height="48" width="48">
                            <p>Организация мероприятий</p>
                            <p class="t4">Продажа услуг
                                <br> по корпоративному обучению</p>
                            <img src="img/building.png" alt height="48" width="48">
                            <p>Производство и оптовые
                                <br> продажи стройматериалов</p>
                            <p class="t4">Изготовление мебели на заказ</p>
                            <img src="img/electronics.png" alt height="48" width="48">
                            <p>Продажи
                                <br> промышленного оборудования</p>
                            <span>Есть пример внедрения</span>
                            <p>Продажа светового
                                <br> и звукового оборудования</p>
                            <span>Есть пример внедрения</span>
                            <p>Монтаж систем безопасности</p>
                        </div>
                    </div>
                    <span class="btn_sec3" href="#">ЗАКАЗАТЬ ПРОБНУЮ ВЕРСИЮ CRM</span>
                </div>
            </section>
            <section class="sec4">
                <div class="wrap">
                    ...
                    <div class="container">
                        <div class="item">
                            ...
                            <p class="p_bold">Более 60% всех звонков
                                <br> обрабатываются в 1 клик</p>
                            <img data-click-event="BUTTONS_FALSE_CLICK" src="img/screenshot2.png" alt height="243" width="224">
                        </div>
                        <div class="item">
                            <span>2</span>
                            ...
                            <p class="p_bold">Мы создали систему, которая
                                ...
                                <br> в нужное время</p>
                            <img data-click-event="CODE_FALSE_CLICK" src="img/screenshot1.png" alt height="290" width="267">
                        </div>
                        <div class="item">
                            <span>3</span>
                            ...
                            <p class="p_bold">В нашей CRM вся история
                                ...
                                <br> на ее изучение</p>
                            <img data-click-event="HISTORY_FALSE_CLICK" src="img/screenshot3.png" alt height="94" width="320">
                        </div>
                    </div>
                </div>
            </section>
            <section class="sec5">
                <div class="wrap">
                    ...
                    <div class="cif_gr">
                        <div class="cif">
                            <div class="cif_img">
                                <img src="img/launch.png" alt height="48" width="48">
                            </div>
                            <div class="cif_t">
                                <h4>80</h4>
                                <p>запусков
                        ...
                        <div class="cif">
                            <div class="cif_img">
                                <img src="img/clients.png" alt height="48" width="48">
                            </div>
                            <div class="cif_t">
                                <h4>300 000</h4>
                        ...
                        <div class="cif">
                            <div class="cif_img">
                                <img src="img/parameters.png" alt height="48" width="48">
                            </div>
                            <div class="cif_t">
                                <h4>16</h4>
                        ...
                        <div class="cif">
                            <div class="cif_img">
                                <img src="img/hours.png" alt height="48" width="48">
                            </div>
                            <div class="cif_t">
                                <h4>200</h4>
                        ...
                        <div class="cif">
                            <div class="cif_img">
                                <img src="img/calls.png" alt height="48" width="48">
                            </div>
                            <div class="cif_t">
                                <h4>15 000</h4>
                    ...
                    <p class="on_btn">Мы берем в работу
                        <span>не более 10 запусков в неделю</span>
                    </p>
                    <a class="btn_sec5" href="#">ПОПРОБОВАТЬ БЕСПЛАТНО</a>
                </div>
            </section>
            <section class="sec6">
                <div class="wrap">
                    ...
                    <div class="cen_gr">
                        <div class="kol">
                            <span class="note">Количество<br> сотрудников</span>
                            <p>7</p>
                            <p>12</p>
                            <p>25</p>
                            <p>безлимит</p>
                        ...
                        <div class="card">
                            ...
                            <div class="divider6"></div>
                            <h4>В облаке<br>
                                <span class="note">(ежемесячно)</span>
                            </h4>
                            <div class="divider5"></div>
                            <div class="f50">
                                <span class="note">За 1 сотрудника</span>
                                <p>536₽</p>
                                <p>458₽</p>
                                <p>410₽</p>
                                <p>308₽</p>
                        ...
                        <div class="card">
                            ...
                            <div class="divider6"></div>
                            <div class="divider6"></div>
                            <h4>На своем сервере<br>
                                <span class="note">(единоразово)</span>
                            </h4>
                            <div class="divider5"></div>
                            <div class="f50">
                                <span class="note">За 1 сотрудника</span>
            ...
            <section class="sec7">
                ...
                <div class="wrap">
                    ...
                    <form enctype="multipart/form-data" action="ajax/mail.php" method="post">
                        <a class="tabl active" data-event="FORM5_FREE" href="#">
                            <span>Бесплатная версия</span>
                        </a>
                        <a class="tabr" data-event="FORM5_FULL" href="#">
            ...
            <section class="sec8">
                <div class="wrap">
                    ...
                    <div class="sec8_hgr">
                        <div class="h_gr">
                            <h3>Компания:</h3>
                            <h4>Представительство<br> TeleTrade (Москва)</h4>
                        </div>
                        <div class="h_gr">
                            <h3>Штат:</h3>
                            <h4>150 менеджеров<br> по холодным звонкам</h4>
                        </div>
                        <div class="h_gr">
                            <h3>Срок запуска:</h3>
                            <h4>1,5 месяца</h4>
                    ...
                    <div class="vipo_r">
                        ...
                        <br>
                        <h4>Интеграция CRM + Asterisk</h4>
                    </div>
                    <div class="divider7"></div>
                    <div class="prim_gr">
                        <div class="prim1">
                            <img class="pr_im1" data-click-event="ORDER_FALSE_CLICK" src="img/example-integration.png" alt height="600" width="284">
                            <div class="prim_t">
                                ...
                                <div class="prim_r">
                                    <p>Все заявки сразу попадают в CRM и автоматически
                                        ...
                                        <br> достаточно 1 клика.</p>
                                    <img data-click-event="QUEUE_FALSE_CLICK" src="img/example-labels.png" alt height width>
                                </div>
                                <div class="prim_r">
                                    <p>При назначении менеджеру новой заявки CRM сразу
                                        <br> информирует его об этом. Через 15 минут, если менеджер
                                        <br> еще не позвонил по заявке, CRM уведомляет его руководителя. </p>
                                    <img data-click-event="REMIND_FALSE_CLICK" src="img/example-remainder.png" alt height="91" width="301">
                                </div>
                                <div class="prim_r">
                                    <p>Кроме того, CRM считает время от получения заявки
                                        <br> до начала работы с ней.</p>
                                    <img data-click-event="TIMING_FALSE_CLICK" src="img/example-request.png" alt height="173" width="451">
                                </div>
                            </div>
                        </div>
                        <div class="prim2">
                            ...
                            <div class="pr_im2" data-click-event="WORKPLACE_FALSE_CLICK">
                                <img src="img/example-zvonok2.png" alt height="425" width="496">
                            </div>
                        </div>
                    </div>
                    <div class="prim3">
                        ...
                        <div class="pr_im3">
                            <img src="img/plan-graph.png" alt height="60" width="61">
                        </div>
                    </div>
                    <div class="divider7"></div>
                    <div class="form_gr">
            ...
            <footer>
                <div class="wrap">
                    ...
                    <div class="kont">
                        ...
                        <h4>
                            <a data-click-event="CALLING" href="tel:+78312910590">+7 831 29-105-90</a>
                        </h4>
                    </div>
                    <div class="kont">
                        <p class="note">Контактный email</p>
                        <h4>
                            <a data-click-event="EMAILING" href="mailto:mail@4calls.ru">mail@4calls.ru</a>
                        </h4>
                    </div>
            ...
            <div id="hidden-box">
                ...
                <div class="pop3" id="pop5">
                    ...
                    <h2>Протестируйте систему<br> перед приобретением</h2>
                    <form enctype="multipart/form-data" action="ajax/mail.php" method="post">
                        <a class="tabl active" data-event="FORM2_6HOURS_FREE" href="#">
                            <span>Бесплатная версия</span>
                        </a>
                        <a class="tabr" data-event="FORM2_6HOURS_FULL" href="#">
                            <span>Полная версия</span>
                        </a>
                ...
                <div class="pop3" id="pop5_1">
                    ...
                    <h2>Протестируйте систему<br> перед приобретением</h2>
                    <form enctype="multipart/form-data" action="ajax/mail.php" method="post">
                        <a class="tabl active" data-event="FORM3_EXAMPLES_FREE" href="#">
                            <span>Бесплатная версия</span>
                        </a>
                        <a class="tabr" data-event="FORM3_EXAMPLES_FULL" href="#">
                            <span>Полная версия</span>
                        </a>
                ...
                <div class="pop3" id="pop5_2">
                    ...
                    <h2>Протестируйте систему<br> перед приобретением</h2>
                    <form enctype="multipart/form-data" action="ajax/mail.php" method="post">
                        <a class="tabl active" data-event="FORM4_FACTS_FREE" href="#">
                            <span>Бесплатная версия</span>
                        </a>
                        <a class="tabr" data-event="FORM4_FACTS_FULL" href="#">
                            <span>Полная версия</span>
                        </a>
                ...
                <div class="pop3" id="pop6">
                    <a class="close" href="#"></a>
                    <img src="img/form-sent-light.png" alt height="50" width="61">
                    <h2>Спасибо за вашу заявку!</h2>
                    <p>Мы свяжемся с вами в ближайшие несколько минут</p>
                </div>
                <div class="vcard">
                    <div>
                        <span class="category">Настройка CRM-систем</span>
                        <span class="fn org">ООО «Маркетинг и консультирование»</span>
                    </div>
                    <div class="adr">
                        <span class="locality">Нижний Новгород</span>
                        <span class="street-address">д.Кузнечиха, д.65А</span>
                    </div>
                    <span class="tel">+7 (831) 235-10-50</span>
                    <span class="workhours">ежедневно с 08:00 до 20:00</span>
                    <span class="url">
                        <span class="value-title" title="http://4calls.ru"> </span>
                    </span>
                </div>
            </div>
